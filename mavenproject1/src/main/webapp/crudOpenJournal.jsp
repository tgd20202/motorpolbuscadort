    ...
    <body>
        ...
        <header class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
            ...
            <nav class="my-2 my-md-0 me-md-3">
                ...
                <a class="p-2 text-dark" href="#">Administrar OJS</a>
                <a class="p-2 text-dark" href="#">Administrar Catálogos</a>
                <a class="p-2 text-dark" href="#">Administrar Usuarios</a>
                <a class="p-2 text-dark" href="#">Historia Favoritos</a>
                 ...
                 <div class=col-md-12>
                    ...
                    <form id="form-list-client">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-default-btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Nuevo OJS</a>
                            <br><br>
                        </div>
                        <table class="table table-bordered table-condensed table-hover">
                            ...
                            <tbody id="form-list-client-body">
                                <tr>
                              <!--      <td>1</td>
                                    <td>Poli Journal System</td>
                                    <td>https://revistas.elpoli.edu.co/index.php/pol/search/search</td>
                                    <td>query</td>
